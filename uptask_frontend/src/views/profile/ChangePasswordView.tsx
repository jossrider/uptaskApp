...
import { UpdateCurrentUserPasswordFomr } from '@/types/index'
import { useMutation } from '@tanstack/react-query'
import { toast } from 'react-toastify'
import { changePassword } from '@/api/ProfileAPI'

export default function ChangePasswordView() {
  const initialValues: UpdateCurrentUserPasswordFomr = {
    current_password: '',
    password: '',
  ...
  const handleChangePassword = (formData: UpdateCurrentUserPasswordFomr) => mutate(formData)
  return (
    <>
