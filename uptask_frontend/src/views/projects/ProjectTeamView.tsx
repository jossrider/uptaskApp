  ...
  if (data)
    return (
      <>
        ...
        <p className='text-2xl font-light text-gray-500 mt-5'>Administra el equipo de tranajo para este proyecto</p>
        <nav className='my-5 flex gap-3'>
          ...
          <Link
            ...
            className='bg-fuchsia-600 hover:bg-fuchsia-700 px-10 py-3 text-white font-bold cursor-pointer transition-colors'>
            Volver al Proyecto
          </Link>
        </nav>
